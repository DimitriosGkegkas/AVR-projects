...
ldi r24 ,1
push r24
ldi r24 ,49 ; delay 49 탎 to meet the standards
ldi r25 ,0 ; for a minimum of 60 탎ec time slot
...
sbrs r24 ,0
cbi PORTA ,PA4
ldi r24 ,58 ; wait 58 탎ec for the
...
cbi PORTA ,PA4
ldi r24 ,100 ; wait 100 탎ec for devices
